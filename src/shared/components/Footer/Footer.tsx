...
const Footer = () => {
  ...
  const icons = [
    {
      link: 'https://www.facebook.com/meitalkTV',
      source: footerFacebook,
      overSource: overFooterFacebook,
    },
    {
      link: 'https://youtube.com',
      source: footerYoutube,
      overSource: overFooterYoutube,
    },
    {
      link: 'https://www.instagram.com/meitalktv/',
      source: footerInsta,
      overSource: overFooterInsta,
    },
    {
      link: 'https://twitter.com/MeiTalkTV',
      source: footerTwit,
      overSource: overFooterTwit,
    },
    {
      link: 'https://t.me/meitalktv',
      source: footerTele,
      overSource: overFooterTele,
    },
    {
      link: 'https://www.linkedin.com/company/meitalk/',
      source: footerLinked,
      overSource: overFooterLinked,
    },
  ];
